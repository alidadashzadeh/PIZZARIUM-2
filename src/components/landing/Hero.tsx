...
export default function Hero() {
	return (
		<>
			<FloatingIngredients />
			<section className="w-full  flex flex-col-reverse gap-32 xl:gap-16 xl:flex-row  md:pt-32 justify-between px-4 sm:px-8  ">
				<div className="max-w-xl space-y-8 ">
					<span className="inline-block text-primary px-3 py-1 sm:px-4 sm:py-1 rounded-full text-xs sm:text-sm font-semibold">
						Fresh & Fast Delivery
					</span>

					<Large className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold sm:leading-tight tracking-tight">
						Delicious Pizza <br />
						Made <RollingWord />
					</Large>
